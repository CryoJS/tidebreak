//Code for Controls/ButtonYellow (Container)
...
partial class ButtonYellow : global::Gum.Forms.Controls.Button
{
    ...
    public static void RegisterRuntimeType()
    {
        var template = new global::Gum.Forms.VisualTemplate((vm, createForms) =>
        {
            ...
            var element = ObjectFinder.Self.GetElementSave("Controls/ButtonYellow");
#if DEBUG
if(element == null) throw new System.InvalidOperationException("Could not find an element named Controls/ButtonYellow - did you forget to load a Gum project?");
#endif
            element.SetGraphicalUiElement(visual, RenderingLibrary.SystemManagers.Default);
            if(createForms) visual.FormsControlAsObject = new ButtonYellow(visual);
            return visual;
        });
        global::Gum.Forms.Controls.FrameworkElement.DefaultFormsTemplates[typeof(ButtonYellow)] = template;
        ElementSaveExtensions.RegisterGueInstantiation("Controls/ButtonYellow", () => 
        {
    ...
    public ButtonYellow(InteractiveGue visual) : base(visual)
    {
    }
    public ButtonYellow()
    {
